...
class AaveDebtToken {
  ...
  AaveDebtToken._(this.token, this.client);

  factory AaveDebtToken(String address, EthClient client) => AaveDebtToken._(
        DeployedContract(
          ContractAbi.fromJson(jsonABI, "AaveDebtToken"),
          EthereumAddress.fromHex(address),
        ),
        client,
      );

  Future<String> approveBorrow(String address, BigInt amount) =>
      client.sendTransaction(
        token,
        token.function("approveDelegation"),
        [
          EthereumAddress.fromHex(address),
          amount,
        ],
